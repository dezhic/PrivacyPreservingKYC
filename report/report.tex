...
\chapter{Problems and Objective}\label{problems-and-objective}}
...
\section{Hyperledger SSI}\label{hyperledger-ssi}}
...
\section{Implementing zkKYC with Hyperledger
...
\chapter{Zero Knowledge Proof (ZKP) with
...
\section{zk-SNARK Fundamentals}\label{zk-snark-fundamentals}}
...
\section{ZKP Workflow for zkKYC}\label{zkp-workflow-for-zkkyc}}
...
\hypertarget{project-review}{%
\chapter{Project Review}\label{project-review}}
...
\section{Project Code Navigation}\label{project-code-navigation}}

\hypertarget{circom-snarkjs}{%
\subsection{Circom \& SnarkJS}\label{circom-snarkjs}}
...
\subsection{Hyperledger Aries}\label{hyperledger-aries-1}}
