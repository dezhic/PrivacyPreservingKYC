...
test('encode didI', t => {
    const arr = utils.did2Uint248Array(didI, 1);
    console.log(arr);
    const decoded = utils.uint248Array2Did(arr);
    console.log(decoded);
    assert.strictEqual(didI, decoded);
});

test('encode didHI', t => {
    const arr = utils.did2Uint248Array(didHI, 1);
    console.log(arr);
    const decoded = utils.uint248Array2Did(arr);
    console.log(decoded);
...
test('encode didHV', t => {
    const arr = utils.did2Uint248Array(didHV, 1);
    console.log(arr);
    const decoded = utils.uint248Array2Did(arr);
    console.log(decoded);
...
test('encode didV', t => {
    const arr = utils.did2Uint248Array(didV, 1);
    console.log(arr);
    const decoded = utils.uint248Array2Did(arr);
    console.log(decoded);
...
test('encode did of 2 * 248 bits (62 bytes)', t => {
    const arr = utils.did2Uint248Array(did62Bytes, 2);
    console.log(arr);
    const decoded = utils.uint248Array2Did(arr);
    console.log(decoded);
